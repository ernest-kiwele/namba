 ...
 */
public class SliceScale implements Slice {

	private static final SliceScale UNBOUNDED = unbounded();
	 ...
	 */
	public SliceScale(int from, boolean leftBounded, int to, boolean rightBounded, int step) {
	 ...
	 */
	public SliceScale(int from, int to, int step) {
	 ...
	 *      instantiation details.
	 */
	public static SliceScale of(int from, int to, int step) {
		return new SliceScale(from, to, step);
	}
	 ...
	 */
	public static SliceScale of(int to) {
		return of(0, to, 1);
	}
	 ...
	 */
	public static SliceScale of(int from, int to) {
		return new SliceScale(from, to, 1);
	}
	 ...
	 *           immutable
	 */
	public static SliceScale unbounded() {
		return UNBOUNDED;
	}
	 ...
	 */
	public static SliceScale from(int from) {
		return new SliceScale(from, true, Integer.MAX_VALUE, false, 1);
	}
	 ...
	 */
	public static SliceScale to(int to) {
		return new SliceScale(Integer.MIN_VALUE, false, to, true, 1);
	}
